...
if __name__ == '__main__':            
    ...
    # Primero determinar la dimensión de las características
    sample_image_path = os.path.join(image_dir, "2007_000027.jpg")  # O cualquier imagen que sepas que existe en tu directorio
    ...
    with open(file_list_path, 'r') as f:
        ...
        # Si cada línea contiene solo el nombre de archivo
